# Contributing to Simple Token Authentication
...
making it easier for developers to [contribute to Simple Token Authentication](#pull-requests).
...
your Operating System, as well as your Erlang, Elixir and Simple Token Authentication versions. Please provide steps to
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/simple_token_authentication

   # Navigate to the newly cloned directory
   cd simple_token_authentication

   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/podium/simple_token_authentication
   ```
